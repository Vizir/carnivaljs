...
define('providers/api.js',[],function () {
...
define('models/entity.js',['require'],function (require) {
...
define('providers/entity.js',['models/entity.js'],function () {
...
define('Config',['require','angular','providers/api.js','providers/entity.js'],function (require) {
...
define('text!templates/main.html',[],function () { return '<style type="text/css">\n  .loading {\n    position: fixed;\n    width: 90px;\n    height: 90px;\n    top: calc(50% - 50px);\n    left: calc(50% - 50px);\n    background: transparent;\n    border: solid 5px rgba(0,0,0,0.25);\n    border-radius: 50%;\n    border-top-color: rgba(0,0,0,0.75);\n    z-index: 100;\n  }\n  .spinner {\n    -webkit-animation: ani 1000ms ease-in-out infinite;\n            animation: ani 1000ms ease-in-out infinite;\n  }\n  @-webkit-keyframes ani {\n    100%{\n      -webkit-transform: rotate(359deg);\n    }\n  }\n\n  @keyframes ani {\n    100%{ transform: rotate(359deg); }\n  }\n\n  .transparent {\n    zoom: 1;\n    filter: alpha(opacity=20);\n    opacity: 0.2;\n  }\n</style>\n\n\n<div class="navbar navbar-default">\n  <div class="container">\n  <a class="navbar-brand">{{ applicationName }}</a>\n  <ul class="nav navbar-nav">\n    <li ui-sref-active="active" ng-repeat="item in menuItems">\n      <a ui-sref="main.list({ entity: item.name })">{{ item.label }}</a>\n    </li>\n  </ul>\n  </div>\n</div>\n\n<div class="container" ng-repeat="notification in notifications">\n  <div ng-show="notification.type === \'success\'" class="alert alert-success" notification>{{ notification.message }}</div>\n  <div ng-show="notification.type === \'warning\'" class="alert alert-warning" notification>{{ notification.message }}</div>\n  <div ng-show="notification.type === \'error\'" class="alert alert-danger" notification>{{ notification.message }}</div>\n</div>\n\n<div class="loading spinner" ng-hide="loading === 0"></div>\n\n<div ng-class="{ transparent: loading !== 0 }">\n  <div ui-view></div>\n</div>\n';});
...
define('text!templates/create.html',[],function () { return '<div class="container">\n\n  <h3>Create {{ entityLabel }}</h3>\n\n  <div ng-repeat="error in errors" class="alert alert-danger" role="alert">\n    {{ error }}\n  </div>\n\n  <form class="simple-form form-horizontal" novalidate>\n    <div class="form-group" ng-repeat="field in entityFields">\n      <label class="col-sm-2 control-label">{{ field.label }}</label>\n      <div class="col-sm-10">\n\n        <input type="{{ field.type }}" class="form-control" placeholder="{{ field.label }}" ng-model="form[field.name]"/>\n      \n      </div>\n    </div>\n    <div class="form-group">\n      <div class="col-sm-offset-2 col-sm-10">\n        <button type="submit" ng-click="save()" class="btn btn-success">Save</button>\n      </div>\n    </div>\n  </form>\n\n</div>';});

define('controllers/create.js',['require','angular'],function (require) {
...
define('text!templates/edit.html',[],function () { return '<div class="container">\n\n  <h3>Edit {{ entityLabel }}</h3>\n\n  <div ng-repeat="error in errors" class="alert alert-danger" role="alert">\n    {{ error }}\n  </div>\n\n  <form class="simple-form form-horizontal" novalidate>\n    <div class="form-group" ng-repeat="field in entityFields">\n      <label class="col-sm-2 control-label">{{ field.label }}</label>\n      <div class="col-sm-10">\n\n        <input type="{{ field.type }}" class="form-control" placeholder="{{ field.label }}" ng-model="form[field.name]"/>\n      \n      </div>\n    </div>\n    <div class="form-group">\n      <div class="col-sm-offset-2 col-sm-10">\n        <button type="submit" ng-click="save()" class="btn btn-success">Save</button>\n      </div>\n    </div>\n  </form>\n\n</div>';});

define('controllers/edit.js',['require'],function (require) {
...
define('Router',['require','angular','angular-ui-router','text!templates/main.html','controllers/main.js','text!templates/list.html','controllers/list.js','text!templates/create.html','controllers/create.js','text!templates/edit.html','controllers/edit.js'],function (require) {
...
define('factories/shared-data',['require','angular'],function (require) {
...
define('directives/directives',['require','angular'],function (require) {
...
define('carnival',['require','angular','Config','Router','factories/shared-data','directives/directives'],function (require) {
